...
const en: LocaleMap = {
    ...
    'settings_input_prompt': 'Input Prompt  —  Your messages → LLM',
    'settings_output_prompt': 'Output Prompt  —  AI responses → Display',
...
const zhCN: LocaleMap = {
    ...
    'settings_input_prompt': '输入提示词  —  你的消息 → 发送给 LLM',
    'settings_output_prompt': '输出提示词  —  AI 回复 → 界面显示',
